...
/* Generated from ../O.Common/ls218.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devls218Version, *pvar_dset_devLsoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devlongoutStream", "devLsiSoft", "devLsiEnviron", "devls218Version",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devwaveformStream, pvar_dset_devWfPDBDemo,
...
epicsShareExtern reg_func pvar_func_GpibBoardDriverRegister,
...
int ls218_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/vishnu/epicsDev/ls218";
...
/* ls218_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"ls218_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    ls218_registerRecordDeviceDriver(*iocshPpdbbase);
}
